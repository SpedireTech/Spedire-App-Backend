    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/user/sign-up", "/api/v1/user/testing",
                                "/api/v1/user/verifyPhoneNumber", "/api/v1/sms/verify-otp", "/api/v1/otp/verifyOtp","/login","/api/v1/order/createOrder", "/api/v1/payment/**","/api/v1/carrier/upgrade", "/api/v1/carrier/status", "/websocket/**", "swagger-ui.html", "swagger-ui/index.html").permitAll()
